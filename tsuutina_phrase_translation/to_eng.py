...
class EnglishGenerator(object):
    ...
    _fst_sbj_to_eng_sbj = {
        ...
        ("SbjSg3", False, False, "mf"): ("he/she", 3, infl.SG, "himself/herself"),
        ("SbjSg3", False, True, None): (
            "he/she/it",
            3,
            infl.SG,
            "himself/herself/itself",
        ...
        ("SbjSg3", False, True, "mf"): ("he/she", 3, infl.SG, "himself/herself"),
        ("SbjSg3", True, False, None): (
            "he/she/it",
            3,
            infl.SG,
            "himself/herself/itself",
        ...
        ("SbjSg3", True, False, "mf"): ("he/she", 3, infl.SG, "himself/herself"),
        ("SbjSg3", True, True, None): (
            "he/she/it",
            3,
            infl.SG,
            "himself/herself/itself",
        ...
        ("SbjSg3", True, True, "mf"): ("he/she", 3, infl.SG, "himself/herself"),
        ("SbjSg4", False, False, None): ("someone", 3, infl.SG, "themself"),
        ("SbjSg4", False, True, None): ("each and every one", 3, infl.SG, "themselves"),
        ("SbjSg4", True, False, None): ("someone (pl.)", 3, infl.SG, "themselves"),
        ("SbjSg4", True, True, None): ("each and every one", 3, infl.SG, "themselves"),
        ("SbjPl1", False, False, None): ("we both", 1, infl.PL, "ourselves"),
        ("SbjPl1", False, True, None): (
        ...
        ("SbjPl1", True, True, None): (
            "each and every one of us",
            3,
            infl.SG,
            "ourselves",
        ),
        ("SbjPl2", False, False, None): ("you both", 2, infl.PL, "yourselves"),
        ("SbjPl2", False, True, None): (
            "each and every one of you",
            3,
            infl.SG,
            "yourselves",
        ),
        ("SbjPl2", True, False, None): ("you all", 2, infl.PL, "yourselves"),
        ("SbjPl2", True, True, None): (
            "each and every one of you",
            3,
            infl.SG,
            "yourselves",
        ),
        ("SbjPl3", False, False, None): ("they both", 3, infl.PL, "themselves"),
        ("SbjPl3", False, True, None): (
            "each and every one of them",
            3,
            infl.SG,
            "themselves",
        ),
        ("SbjPl3", True, False, None): ("they all", 3, infl.PL, "themselves"),
        ("SbjPl3", True, True, None): (
            "each and every one of them",
            3,
            infl.SG,
            "themselves",
    ...
    _eng_sbj_to_fst_sbj_and_gender = dict(
        [
            (eng_sbj, (fst_sbj, gender))
            for (fst_sbj, _, _, gender), (
                eng_sbj,
                _,
                _,
                _,
            ) in _fst_sbj_to_eng_sbj.items()
        ]
    )
    ...
    _fst_obj_to_eng_obj = {
        ...
        ("ObjSg4", True, None): ("each and every one of someone (pl.)", 3, infl.SG),
        ...
        ("ObjRecip", True, None): ("each and every one of each other", None, None),
        ("ObjRecip", False, None): ("each other", None, None),
        ("ObjRefl", True, None): ("self", None, None),
        ("ObjRefl", False, None): ("self", None, None),
        ("ObjIndef", True, None): ("each and every one of something", 3, infl.SG),
        ("ObjIndef", False, None): ("something", 3, infl.SG),
        ("ObjAreal", True, None): (
            "each and every one of them " "(places/spaces)",
            3,
            infl.SG,
        ),
    ...
    def _to_english_subjects(self, fst_sbj, sbj_pl_only, distrib, gender_3sg=None):
        return self._fst_sbj_to_eng_sbj[(fst_sbj, sbj_pl_only, distrib, gender_3sg)]

    def _to_english_objects(
        self,
        fst_obj,
        sbj_form,
        sbj_person,
        ...
        fst_obj = fst_obj[1:]
        obj_form, obj_person, obj_number = self._fst_obj_to_eng_obj[
            (fst_obj, distrib, gender_3sg)
        ]
    ...
    def _to_english_participants(
        ...
        if argument_structure == "Im":
            return [{"SbjForm": "it", "SbjPerson": 3, "SbjNumber": infl.SG}]

        elif argument_structure == "I":
            sbj_form, sbj_person, sbj_number, sbj_refl = self._to_english_subjects(
                fst_sbj, sbj_pl_only, distrib
            )
            return [
                {
                    "SbjForm": sbj_form,
                    "SbjPerson": sbj_person,
                    "SbjNumber": sbj_number,
                    "SbjRefl": sbj_refl,
                }
            ]
            ...
            sbj_form, sbj_person, sbj_number, sbj_refl = self._to_english_subjects(
                fst_dobj.replace("DObj", "Sbj"), sbj_pl_only, distrib
            )
            return [
                {
                    "SbjForm": sbj_form,
            ...
            # subject in English.
            sbj_form, sbj_person, sbj_number, sbj_refl = self._to_english_subjects(
                fst_iobj.replace("IObj", "Sbj"), sbj_pl_only, distrib
            )
            return [
                {
                    "SbjForm": sbj_form,
            ...
            if distrib and not "NomzPl" in fst_rest:
                ...
                if sbj_distrib and obj_distrib:
                    ...
                    results.append(
                        self._sbj_and_objs_to_dict(
                            sbj, dobj=self._to_english_objects(fst_dobj, *sbj, False)
                        )
                    )
                    ...
                    results.append(
                        self._sbj_and_objs_to_dict(
                            sbj, dobj=self._to_english_objects(fst_dobj, *sbj, True)
                        )
                    )
            ...
            # forms/values.
            sbj = self._to_english_subjects(
                fst_sbj, sbj_pl_only, distrib and sbj_distrib
            )
            return [
                self._sbj_and_objs_to_dict(
                    sbj,
                    dobj=self._to_english_objects(
                        fst_dobj, *sbj, distrib and obj_distrib
                    ),
                )
            ]
            ...
            if distrib and not "NomzPl" in fst_rest:
                ...
                if sbj_distrib and obj_distrib:
                    ...
                    results.append(
                        self._sbj_and_objs_to_dict(
                            sbj, iobj=self._to_english_objects(fst_iobj, *sbj, False)
                        )
                    )
                    ...
                    results.append(
                        self._sbj_and_objs_to_dict(
                            sbj, iobj=self._to_english_objects(fst_iobj, *sbj, True)
                        )
                    )
            ...
            return [
                self._sbj_and_objs_to_dict(
                    sbj,
                    iobj=self._to_english_objects(
                        fst_iobj, *sbj, distrib and obj_distrib
                    ),
                )
            ]
            ...
            if not distrib:
                ...
                dobj_form, dobj_person, dobj_number = self._to_english_objects(
                    fst_dobj, sbj_form, sbj_person, sbj_number, sbj_refl, distrib
                )

                iobj_form, iobj_person, iobj_number = self._to_english_objects(
                    fst_iobj, sbj_form, sbj_person, sbj_number, sbj_refl, distrib
                )
                ...
                return [
                    {
                        ...
                        "SbjRefl": sbj_refl,
                        "DObjForm": dobj_form,
                        "DObjPerson": dobj_person,
                        "DObjNumber": dobj_number,
                        "IObjForm": iobj_form,
                        "IObjPerson": iobj_person,
    ...
    def apply(
        ...
        senses=None,
        sbj_conditions=None,
        dobj_conditions=None,
        iobj_conditions=None,
        adjust_tense=None,
        ...
        fst_lemma, fst_pos, fst_arg, fst_aspect, *fst_rest = fst_tags.split("+")
        ...
        if "DObjRefl" in fst_rest or "IObjRefl" in fst_rest:
            senses = re.sub(
                r"(himself/herself/itself|himself/herself|" r"himself|herself|itself)",
                "self",
                senses,
            )
        ...
        for sense_group in senses_and_subsenses:
            ...
            for sense in sense_group:
                ...
                _, eng_sbj_gender = self._eng_sbj_to_fst_sbj_and_gender[eng_sbj_form]
                ...
                participant_options = self._to_english_participants(
                    fst_arg,
                    fst_sbj,
                    fst_dobj,
                    fst_iobj,
                ...
                for participants in participant_options:
                    ...
                    if expand_placeholders and "self's" in after_verb:
                        ...
                        poss_pron = self._fst_person_number_to_eng_poss[
                            (sbj_pers_num, eng_sbj_gender)
                        ]
                        if poss_pron:
                            after_verb = after_verb.replace("self's", poss_pron)
                    ...
                    # with the subject.
                        ...
                        if fst_arg in ["Im", "I", "DE", "OE"]:
                            after_verb = after_verb.replace(
                                "self", participants["SbjRefl"]
                            )
                    ...
                    if adjust_tense and fst_aspect != "IPFV":
                        ...
                        if eng_verb in [
                            ...
                            if adjust_tense == "event" and (
                                after_verb.startswith("about to")
                                or after_verb.startswith("just about to")
                                or after_verb.startswith("just about")
                            ):
                            ...
                            # Stative verbs: "I am sitting" --> "I am sitting"
                                ...
                                if eng_verb == "will" and after_verb_parts[0] == "be":
                                    eng_verb = infl.conjugate(
                                        "be",
                                        infl.PRESENT,
                                        person=sbj_person,
                        ...
                        if fst_aspect == "PFV":
                            ...
                            be_verb = infl.conjugate(
                                "be", infl.PRESENT, person=sbj_person, number=sbj_number
                            )
                            pres_part_eng_verb = infl.conjugate(
                                eng_verb,
                                infl.PRESENT,
                            ...
                            keep_verb = infl.conjugate(
                                "keep", infl.PAST, person=sbj_person, number=sbj_number
                            )
                    ...
                    if "DObjForm" in participants:
                        ...
                        if (
                            "NomzPl" in fst_rest
                            and participants["DObjPerson"] == 3
                            and participants["DObjNumber"] == "singular"
                        ):
                            after_verb = re.sub(
                                r"(O|something|someone)", "", after_verb
                            )
                        else:
                            after_verb_parts = after_verb.split(" ")
                            if "O" in after_verb_parts:
                                after_verb = after_verb.replace(
                                    "O", participants["DObjForm"]
                                )
                            elif "self" in after_verb_parts and expand_placeholders:
                                after_verb = after_verb.replace(
                                    "self", participants["DObjForm"]
                                )
                            elif "something" in after_verb_parts:
                                after_verb = after_verb.replace(
                                    "something", participants["DObjForm"]
                                )
                    ...
                    if "IObjForm" in participants:
                        ...
                        if (
                            "NomzPl" in fst_rest
                            and participants["IObjPerson"] == 3
                            and participants["IObjNumber"] == "singular"
                        ):
                            after_verb = re.sub(
                                r"(IO|something|someone|" "somethingP|someoneP)",
                                "",
                                after_verb,
                            )
                        else:
                            ...
                            if "IO" in after_verb_parts:
                                after_verb = after_verb.replace(
                                    "IO", participants["IObjForm"]
                                )
                            elif "selfP" in after_verb_parts and expand_placeholders:
                                after_verb = after_verb.replace(
                                    "selfP", participants["IObjForm"]
                                )
                            ...
                            # these oblique object forms.
                                ...
                                after_verb = after_verb.replace(
                                    "somethingP", participants["IObjForm"]
                                )
                            ...
                            # require disambiguation).
                                ...
                                after_verb = after_verb.replace(
                                    "self", participants["IObjForm"]
                                )
                            elif "something" in after_verb_parts:
                                after_verb = after_verb.replace(
                                    "something", participants["IObjForm"]
                                )
                            elif "someone" in after_verb_parts:
                                after_verb = after_verb.replace(
                                    "someone",
                    ...
                    if "DF" in fst_rest:
                        ...
                        # again and again later on"
                            ...
                            if eng_verb == "have":
                                ...
                                # ("eaten").
                                past_participle = infl.conjugate(
                                    verb=eng_verb_lemma,
                                    tense=infl.PAST,
                                    aspect=infl.PROGRESSIVE,
                                )
                                ...
                                eng_verb = "would"
                                after_verb = f"have {past_participle} {after_verb}"
                        ...
                        # later on"
                            ...
                            if eng_verb_lemma == "would":
                                ...
                                after_verb = after_verb.removeprefix(
                                    lexical_verb
                                ).strip()
                    ...
                    if "Relz" in fst_rest:
                        ...
                        if sbj_person == 3:
                            phr = f"the one {which} {verb} {after_verb}".strip()
                            if not phr in english:
                                english.append(phr)
                        ...
                        # around that participant.
                            ...
                            participants.get("DObjPerson") == 3
                            and participants.get("DObjNumber") == "singular"
                        ) or (
                            participants.get("IObjPerson") == 3
                            and participants.get("IObjNumber") == "singular"
                        ):
                            phr = (
                                f"the one {which} {sbj_form} {verb} "
                                f"{after_verb}".strip()
                            )
                        ...
                        if (
                            sbj_person == 3
                            or participants.get("DObjPerson") == 3
                            or participants.get("IObjPerson") == 3
                        ):
                            ...
                            # ones that" as a subject).
                                ...
                                phr = "the ones that " f"{verb} {after_verb}".strip()
        ...
        english_senses = [
            (", ".join(sorted(subsense_phrases))).replace("  ", " ")
